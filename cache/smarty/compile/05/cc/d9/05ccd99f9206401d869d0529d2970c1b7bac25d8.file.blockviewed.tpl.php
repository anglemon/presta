<?php /* Smarty version Smarty-3.1.19, created on 2017-09-08 09:56:35
         compiled from "D:\CFYC\SourceCode\prestashop\themes\theme1133\modules\blockviewed\blockviewed.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1181459b206e3b2c887-70248857%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '05ccd99f9206401d869d0529d2970c1b7bac25d8' => 
    array (
      0 => 'D:\\CFYC\\SourceCode\\prestashop\\themes\\theme1133\\modules\\blockviewed\\blockviewed.tpl',
      1 => 1499342965,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1181459b206e3b2c887-70248857',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59b206e3b6e5f1_14701755',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59b206e3b6e5f1_14701755')) {function content_59b206e3b6e5f1_14701755($_smarty_tpl) {?><!-- Block Viewed products -->
...
?>
				<li class="clearfix<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['last']) {?> last_item<?php } elseif ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['first']) {?> first_item<?php } else { ?> item<?php }?>">
					<a class="products-block-image" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['viewedProduct']->value->product_link, ENT_QUOTES, 'UTF-8', true);?>
...
" >
						<img class="img-responsive" src="<?php if (isset($_smarty_tpl->tpl_vars['viewedProduct']->value->id_image)&&$_smarty_tpl->tpl_vars['viewedProduct']->value->id_image) {?><?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['viewedProduct']->value->link_rewrite,$_smarty_tpl->tpl_vars['viewedProduct']->value->cover,'tm_small_default');?>
<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['img_prod_dir']->value;?>
<?php echo $_smarty_tpl->tpl_vars['lang_iso']->value;?>
-default-small_default.jpg<?php }?>" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['viewedProduct']->value->legend, ENT_QUOTES, 'UTF-8', true);?>
" />
					</a>
					<div class="product-content">
						<h5>
							<a class="product-name"	href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['viewedProduct']->value->product_link, ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'More about %s','mod'=>'blockviewed','sprintf'=>array(htmlspecialchars($_smarty_tpl->tpl_vars['viewedProduct']->value->name, ENT_QUOTES, 'UTF-8', true))),$_smarty_tpl);?>
">
