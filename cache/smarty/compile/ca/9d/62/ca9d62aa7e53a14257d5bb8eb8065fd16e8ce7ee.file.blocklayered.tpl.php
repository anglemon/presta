<?php /* Smarty version Smarty-3.1.19, created on 2017-09-08 14:27:15
         compiled from "D:\CFYC\SourceCode\prestashop\themes\theme1133\modules\blocklayered\blocklayered.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2411759b24653b48eb8-71723789%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca9d62aa7e53a14257d5bb8eb8065fd16e8ce7ee' => 
    array (
      0 => 'D:\\CFYC\\SourceCode\\prestashop\\themes\\theme1133\\modules\\blocklayered\\blocklayered.tpl',
      1 => 1499342964,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2411759b24653b48eb8-71723789',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59b24653ec3eb0_95520568',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59b24653ec3eb0_95520568')) {function content_59b24653ec3eb0_95520568($_smarty_tpl) {?><!-- Block layered navigation module -->
<?php if ($_smarty_tpl->tpl_vars['nbr_filterBlocks']->value!=0) {?>
<section id="layered_block_left" class="block">
	<h4 class="title_block"><?php echo smartyTranslate(array('s'=>'Catalog','mod'=>'blocklayered'),$_smarty_tpl);?>
</h4>
...
"<?php }?>>
                                                	<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['value']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
                                                    	...
                                                    	<?php if ($_smarty_tpl->tpl_vars['layered_show_qties']->value) {?>
...
_slider" 
                                            data-type="<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
" 
								...
								<?php } else { ?>
									...
									<li class="nomargin">
	                                    <div class="first-item form-group">
	                                    	<label class="form-label"><?php echo smartyTranslate(array('s'=>'From','mod'=>'blocklayered'),$_smarty_tpl);?>
...
_range_min" type="text" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['filter']->value['values'][0];?>
"/>
	                                    </div>
	                                    <div class="form-group">
	                                    	<label class="form-label"><?php echo smartyTranslate(array('s'=>'to','mod'=>'blocklayered'),$_smarty_tpl);?>
(<?php echo $_smarty_tpl->tpl_vars['filter']->value['unit'];?>
)</label> 
	                                    	<input class="layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
